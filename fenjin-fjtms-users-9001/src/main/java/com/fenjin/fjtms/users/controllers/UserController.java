...
import com.fenjin.fjtms.users.BaseController;
...
public class UserController extends BaseController {
    ...
    @ApiImplicitParam(paramType="body", name = "user", value = "有效的用户实例", required = true, dataType = "User")
    public Object edit(@Valid @RequestBody User user, BindingResult bindingResult) {
    ...
    public Object list(@RequestBody(required = false) UserSearchModel userSearchModel, @PathVariable Integer pageIndex, @PathVariable Integer pageSize) {
